<nav x-data="{ open: false }" class="bg-white border-b border-gray-200">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route(auth()->user() && auth()->user()->role === 'admin' ? 'peminjaman.index' : 'peminjaman.siswa.index')" :active="request()->routeIs('peminjaman.*') || request()->routeIs('peminjaman.siswa.*')">
                        {{ __('Peminjaman Buku') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Menu Peminjaman Buku (Mobile) -->
            <x-responsive-nav-link :href="route(auth()->user() && auth()->user()->role === 'admin' ? 'peminjaman.index' : 'peminjaman.siswa.index')" :active="request()->routeIs('peminjaman.*') || request()->routeIs('peminjaman.siswa.*')">
                {{ __('Peminjaman Buku') }}
            </x-responsive-nav-link>
